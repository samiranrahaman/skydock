        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer" style="height:71px;width: 100%;"/>')
                   // .css("height", tools.getCellSize() * element.headerRows + "px")
                    .css("width", "100%")
					.append('<div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Vessel</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Prod</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Vol</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Rate</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Berth</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label"> Start time</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">End Time</span></div><div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">Span</span></div>'));

                var entries = [];
				//entries.push('<div class="row name row0 fn-wide" id="rowheader0" offset="0"><span class="fn-label">TBD</span></div>');
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        ...
                        if (entry.desc) {
                            entries.push('<div class="row name row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.desc + '</span>');
                            entries.push('</div>');
                        }
						if (entry.prod) {
                            entries.push('<div class="row name row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.prod + '</span>');
                            entries.push('</div>');
                        }
						if (entry.vol) {
                            entries.push('<div class="row name row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.vol + '</span>');
                            entries.push('</div>');
                        }
						if (entry.rate) {
                            entries.push('<div class="row name row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.rate + '</span>');
                            entries.push('</div>');
                        }
						...
						if (entry.span) {
                            entries.push('<div class="row name row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.span + '</span>');
                            entries.push('</div>');
                        }
